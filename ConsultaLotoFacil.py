...
def LotoFacil():
    ...
    page = requests.get('https://www.sorteonline.com.br/lotofacil/resultados')
    ...
    def escrever_json(lista):
        with open('LotoFacil.json', 'w') as f:
            json.dump(lista, f)


    def carregar_json(arquivo):
        with open('LotoFacil.json', 'r') as f:
            return json.load(f)



    minha_lista = {"Jogo":"Loto Facil","Concurso":concurso,"Data":data, "n1":n1, "n2":n2,"n3":n3,"n4":n4,"n5":n5,"n6":n6,"n7":n7,"n8":n8,"n9":n9,"n10":n10,"n11":n11,"n12":n12,"n13":n13,"n14":n14,"n15":n15,"Data da Consulta":dataAtual,"Hora da Consulta":horaAtual}
    escrever_json(minha_lista)

    print(carregar_json('LotoFacil.json'))
